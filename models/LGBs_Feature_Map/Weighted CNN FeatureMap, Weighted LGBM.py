...
#        yFac1 = pd.factorize(y_valid)[0]
        ...
        #trainNN[trainNN.columns[0]] = pd.factorize(trainNN[trainNN.columns[0]])[0]
        #validNN[validNN.columns[0]] = pd.factorize(validNN[validNN.columns[0]])[0]
        
        #trainNN[trainNN.columns[4]] = pd.factorize(trainNN[trainNN.columns[4]])[0]
        #validNN[validNN.columns[4]] = pd.factorize(validNN[validNN.columns[4]])[0]
