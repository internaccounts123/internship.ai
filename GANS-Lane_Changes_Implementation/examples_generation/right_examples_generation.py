...
def generate_right_example(generator):
...
def generate_plot_right(generator):
    %pylab inline
    example = generate_right_example(generator)
...
model_path = "../gans_weights/right_lane_weights/GEN_WEIGHTS.h5"
generator = build_generator()
generator.compile(loss='binary_crossentropy',optimizer=Adam(0.0002, 0.5))
generator.load_weights(model_path)
generate_plot_right(generator)